"""
Init module for spotdl_romanized_lyrics. This module contains the main entry point for spotdl_romanized_lyrics.
And spotdl_romanized_lyrics class
"""
...
from spotdl_romanized_lyrics.utils.spotify import SpotifyClient
from spotdl_romanized_lyrics.console import console_entry_point
from spotdl_romanized_lyrics.download import Downloader
from spotdl_romanized_lyrics.utils.search import parse_query
from spotdl_romanized_lyrics.types import Song
from spotdl_romanized_lyrics._version import __version__


class spotdl_romanized_lyrics:
    """
    spotdl_romanized_lyrics class, which simplifies the process of downloading songs from Spotify.

    ```python
    from spotdl_romanized_lyrics import spotdl_romanized_lyrics

    spotdl_romanized_lyrics = spotdl_romanized_lyrics(client_id='your-client-id', client_secret='your-client-secret')

    songs = spotdl_romanized_lyrics.search(['joji - test drive',
        'https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT'])

    results = spotdl_romanized_lyrics.download_songs(songs)
    ...
    def __init__(
        ...
        """
        Initialize the spotdl_romanized_lyrics class
