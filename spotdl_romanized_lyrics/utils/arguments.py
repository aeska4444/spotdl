...
from spotdl_romanized_lyrics import _version
from spotdl_romanized_lyrics.download.progress_handler import NAME_TO_LEVEL
from spotdl_romanized_lyrics.utils.ffmpeg import FFMPEG_FORMATS
from spotdl_romanized_lyrics.utils.formatter import VARS
from spotdl_romanized_lyrics.download.downloader import (
    AUDIO_PROVIDERS,
    LYRICS_PROVIDERS,
    TRANSLATE_PROVIDERS,
)
...
def parse_arguments() -> Namespace:
    ...
    parser = ArgumentParser(
        prog="spotdl_romanized_lyrics",
        description="Download your Spotify playlists and songs along with album art and metadata",
        formatter_class=SmartFormatter,
        epilog=(
            "For more information, visit http://spotdl_romanized_lyrics.rtfd.io/ "
...
def parse_main_options(parser: _ArgumentGroup):
    ...
    # Translate provider argument
    parser.add_argument(
        "--translation",
        dest="translate_providers",
        nargs="*",
        choices=TRANSLATE_PROVIDERS.keys(),
        help="The translate provider to use. You can provide more than one for fallback.",
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "It's located under C:\\Users\\user\\.spotdl_romanized_lyrics\\config.json "
            "or ~/.spotdl_romanized_lyrics/config.json under linux"
        ),
    )
...
def parse_output_options(parser: _ArgumentGroup):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "It has to end with .spotdl_romanized_lyrics. "
...
def parse_misc_options(parser: _ArgumentGroup):
    ...
    # Add translate argument
    parser.add_argument(
        "--add_translation", "-t",
        action="store_const",
        const=True,
        help="Use a translate.",
    )
...
def parse_other_options(parser: _ArgumentGroup):
    ...
    parser.add_argument(
        "--download-ffmpeg",
        action="store_true",
        help="Download ffmpeg to spotdl_romanized_lyrics directory.",
    )
