...
from spotdl_rl.types.album import Album
from spotdl_rl.types.artist import Artist
from spotdl_rl.types.playlist import Playlist
from spotdl_rl.types.saved import Saved
from spotdl_rl.types.song import Song, SongList
from spotdl_rl.utils.metadata import get_file_metadata
...
def get_simple_songs(
    ...
    for request in query:
        ...
        elif request.endswith(".spotdl_rl"):
