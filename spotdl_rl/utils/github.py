"""
Module for getting information about the current version of spotdl_rl
...
from spotdl_rl import _version
...
REPO = "spotdl_rl/spotify-downloader"
WEB_APP_URL = "https://github.com/spotdl_rl/web-ui/tree/master/dist"
...
def get_status(start: str, end: str, repo: str = REPO) -> Tuple[str, int, int]:
    ...
    - repo: the repo to check (defaults to spotdl_rl/spotify-downloader)
...
def get_latest_version(repo: str = REPO) -> str:
    """
    Get the latest version of spotdl_rl.
